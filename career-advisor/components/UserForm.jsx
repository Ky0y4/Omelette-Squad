...
const FIELDS = [
  ...
  },
  {
    ...
    hint: 'Choose the option that best reflects your education budget',
    type: 'select',
    options: [
      { value: 'low', label: 'Low' },
  ...
  },
  {
    ...
    hint: 'How comfortable are you with financial or career uncertainty?',
    type: 'select',
    options: [
      { value: 'low', label: 'Low' },
      { value: 'high', label: 'High' },
...
export default function UserForm({ onAnalyze }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const description = FIELDS.filter((f) => f.type !== 'select')
    ...
    try {
      await onAnalyze({
        ...
        budget_constraint: values.budget_constraint,
