...
function CareerCard({ career, rank }) {
  ...
  const finalScore = career.final_score ?? career.match_score ?? 0;
    ...
    <div className="career-card">
      <div className="card-header">
        ...
        <div className="card-header-text">
          ...
          <div className="final-score">
            ...
            <strong>{Number(finalScore).toFixed(1)}%</strong>
          </div>
        </div>
      </div>
      ...
      <div className="card-body">
        ...
        <div className="roi-panel">
          {career.roe_percentage != null && (
            <div className="roi-block">
              <h5>ROE</h5>
              <p>{Number(career.roe_percentage).toFixed(1)}%</p>
            </div>
          )}
          {career.break_even_years != null && (
            <div className="roi-block">
              <h5>Break-even years</h5>
              <p>{Number(career.break_even_years).toFixed(1)}</p>
            </div>
          )}
        </div>
